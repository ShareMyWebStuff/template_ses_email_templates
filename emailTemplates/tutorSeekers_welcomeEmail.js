const tutorSeekersWelcomeEmail = () => {
    ...
    const TEMPLATENAME = 'TutorSeekers_WelcomeEmail';
    ...
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:20px"><span class="es-button-border" style="border-style:solid;border-color:#26A4D3;background:#141464;border-width:0px;display:inline-block;border-radius:50px;width:auto"><a href="{{domainName}}/verify-media/{{verificationCode}}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;transition:all 100ms ease-in;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;color:#FFFFFF;border-style:solid;border-color:#141464;border-width:15px 30px 15px 30px;display:inline-block;background:#141464;border-radius:50px;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center">Verify Account</a></span></td> \n` +
    '                     </tr> \n' +
    '                   </table></td> \n' +
    '                 </tr> \n' +
    '               </table></td> \n' +
    ...
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="left" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#333333">Your account has been created and is awaiting to be verified. You have 24 hours in which to verify the account by clicking the button above or visiting {{domainName}}/verify-media and entering the verification code {{verificationCode}}.</p></td> \n` +
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
  ...
  "{{domainName}}/verify-media/ \n\n" +
  "Or you can goto the below link which will automatically verify your account details.\n" +
  "{{domainName}}/verify-media/{{verificationCode}} \n\n" +
  "This email is valid for 24 hours from when it was sent, if it has expired then you will need to get it resent.\n\n" +
