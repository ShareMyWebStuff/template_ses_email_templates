const tutorSeekersWelcomeEmail = () => {

    const TEMPLATENAME = 'TutorSeekersCoUk_WelcomeEmail';
    const SUBJECT_PART = 'Welcome to {{websiteName}}.';
    ...
    '         <tr style="border-collapse:collapse"> \n' +
    '          <td align="center" style="padding:0;Margin:0"> \n' +
    '           <table class="es-header-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#282828;width:600px" cellspacing="0" cellpadding="0" bgcolor="#282828" align="center"> \n' +
    '             <tr style="border-collapse:collapse"> \n' +
    '              <td style="Margin:0;padding-top:30px;padding-bottom:30px;padding-left:40px;padding-right:40px;background-color:#282828" bgcolor="#282828" align="left"> \n' +
    '               <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> \n' +
    '                 <tr style="border-collapse:collapse"> \n' +
    '                  <td valign="top" align="center" style="padding:0;Margin:0;width:520px"> \n' +
    '                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="left" style="padding:0;Margin:0;font-size:0px"><a href="{{domainName}}/" target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:14px;text-decoration:underline;color:#FFFFFF"><img src="https://fduhmi.stripocdn.email/content/guids/CABINET_7bd2f730f4f191f459d79adf93027b30/images/50371606687820335.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="212"></a></td> \n` +
    '                     </tr> \n' +
    '                   </table></td> \n' +
    '                 </tr> \n' +
    '               </table></td> \n' +
    ...
    '                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px;padding-top:40px"><h1 style="Margin:0;line-height:30px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:25px;font-style:normal;font-weight:bold;color:#EF4136">WELCOME</h1></td> \n` +
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td esdev-links-color="#757575" align="center" style="Margin:0;padding-top:10px;padding-bottom:20px;padding-left:30px;padding-right:30px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#F7941D">Click the link below to activate your account.</p></td> \n` +
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:20px"><span class="es-button-border" style="border-style:solid;border-color:#26A4D3;background:#141464;border-width:0px;display:inline-block;border-radius:50px;width:auto"><a href="{{domainName}}/user/verify-media/{{verificationCode}}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;transition:all 100ms ease-in;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;color:#FFFFFF;border-style:solid;border-color:#141464;border-width:15px 30px 15px 30px;display:inline-block;background:#141464;border-radius:50px;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center">Verify Account</a></span></td> \n` +
    '                     </tr> \n' +
    '                   </table></td> \n' +
    '                 </tr> \n' +
    '               </table></td> \n' +
    ...
    '                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td class="es-m-txt-c" align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:25px"><h2 style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;font-style:normal;font-weight:bold;color:#333333">Verify your Account</h2></td> \n` +
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="left" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#333333">Your account has been created and is awaiting to be verified. You have 24 hours in which to verify the account by clicking the button above or visiting {{domainName}}/user/verify-media and entering the verification code {{verificationCode}}.</p></td> \n` +
    '                     </tr> \n' +
    // '                     <tr style="border-collapse:collapse"> \n' +
    // `                      <td align="left" style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#333333"><strong>Your account has been created with the below details</strong><br><br><span style="font-size:12px">Email:<br>Password:</span></p></td> \n` +
    // '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    // `                      <td align="left" style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#333333">If the verification code has expired, you will need to get it resent. To resend your email you will need to re-register.</p></td> \n` +
    `                      <td align="left" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#333333">If the verification code has expired, you will need to get it resent. To resend your email you will need to re-register.</p></td> \n` +
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="left" bgcolor="transparent" style="padding:0;Margin:0;padding-bottom:5px;padding-top:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#333333">Yours sincerely,</p></td> \n` +
    '                     </tr> \n' +
    '                   </table></td> \n' +
    '                 </tr> \n' +
    '               </table></td> \n' +
    ...
    '                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="left" style="padding:0;Margin:0;padding-top:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;color:#333333"><b>The TutorSeekers Crew</b></p></td> \n` +
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;color:#FFFFFF"><br></p></td> \n` +
    '                     </tr> \n' +
    '                   </table></td> \n' +
    '                 </tr> \n' +
    '               </table></td> \n' +
    ...
    '                          <td valign="top" align="center" style="padding:0;Margin:0"><img title="Instagram" src="https://fduhmi.stripocdn.email/content/assets/img/social-icons/rounded-colored/instagram-rounded-colored.png" alt="Ig" width="24" height="24" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></td> \n' +
    '                         </tr> \n' +
    '                       </table></td> \n' +
    '                     </tr> \n' +
    '                   </table></td> \n' +
    ...
    '                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
    `                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#666666">This email was sent to you from support@{{domainName}}</p></td> \n` +
    '                     </tr> \n' +
    '                     <tr style="border-collapse:collapse"> \n' +
  ...
  "In order to complete your registration you need to verify your account. This can be completed by visiting the link below and entering the verification code {{verificationCode}} \n" +
  "{{domainName}}/user/verify-media/ \n\n" +
  "Or you can goto the below link which will automatically verify your account details.\n" +
  "{{domainName}}/user/verify-media/{{verificationCode}} \n\n" +
  "This email is valid for 24 hours from when it was sent, if it has expired then you will need to get it resent. To resend your email you will need to re-register.\n\n" +
  "Yours sincerely,\n" +
...
module.exports.tutorSeekersWelcomeEmail = tutorSeekersWelcomeEmail;
