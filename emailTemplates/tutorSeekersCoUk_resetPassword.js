...
const tutorSeekersPasswordReset = () => {

    const TEMPLATENAME = 'TutorSeekersCoUk_PasswordReset';
    const SUBJECT_PART = 'Password reset for {{websiteName}}.';
    const TEXT_PART = "Dear {{name}},\n\n" + 
    "A request was recently made to reset your {{websiteName}} password. If you never requested this password reset then ignore this email. Please click the link below to access the password reset page.\n\n" +
    "{{domainName}}/reset-password/{{resetCode}} \n\n" +
    "This email is valid for 4 hours from when it was sent, if it has expired then you will need to request another password reset.\n\n" +
    "Yours sincerely,\n" +
  ...
  '                     </tr> \n' +
  '                     <tr style="border-collapse:collapse;"> \n' +
  `                      <td esdev-links-color="#757575" align="center" style="Margin:0;padding-top:10px;padding-bottom:20px;padding-left:30px;padding-right:30px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#FFFFFF;">Click the button below to reset your password.</p></td> \n` +
  '                     </tr> \n' +
  '                     <tr style="border-collapse:collapse;"> \n' +
  `                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:20px;"><span class="es-button-border" style="border-style:solid;border-color:#26A4D3;background:#375E97;border-width:0px;display:inline-block;border-radius:50px;width:auto;"><a href="{{domainName}}/reset-password/{{resetCode}}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;transition:all 100ms ease-in;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;color:#FFFFFF;border-style:solid;border-color:#375E97;border-width:15px 30px 15px 30px;display:inline-block;background:#375E97;border-radius:50px;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center;">Reset Password</a></span></td> \n` +
  '                     </tr> \n' +
  '                   </table></td> \n' +
  '                 </tr> \n' +
  '               </table></td> \n' +
  ...
  '                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> \n' +
  '                     <tr style="border-collapse:collapse;"> \n' +
  `                      <td class="es-m-txt-c" align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:25px;"><h2 style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;font-style:normal;font-weight:bold;color:#FFFFFF;">Password Reset</h2></td> \n` +
  '                     </tr> \n' +
  '                     <tr style="border-collapse:collapse;"> \n' +
  `                      <td align="left" style="padding:0;Margin:0;padding-bottom:10px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#FFFFFF;">A request was recently made to reset your {{websiteName}} password. If you never requested this password then ignore this email. You have 4 hours in which to reset your password by clicking the button above or visiting {{domainName}}/reset-password/{{resetCode}}.</p></td> \n` +
  '                     </tr> \n' +
  '                     <tr style="border-collapse:collapse;"> \n' +
  ...
  '                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> \n' +
  '                     <tr style="border-collapse:collapse;"> \n' +
  `                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#666666;">This email was sent to you from {{supportEmail}}</p></td> \n` +
  '                     </tr> \n' +
  '                     <tr style="border-collapse:collapse;"> \n' +
...
module.exports.tutorSeekersPasswordReset = tutorSeekersPasswordReset;
